...
namespace VoiceMeeterWrapper
{
    public static class VoiceMeeterRemote
    {
        ...
        public static extern int GetGetLevel(int type, int index, ref float value);

        [DllImport("VoicemeeterRemote.dll", EntryPoint = "VBVMR_GetParameters")]
        public static extern int SetParameters(string szParamName);
